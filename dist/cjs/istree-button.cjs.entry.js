...
const IstreeButton = class {
  ...
  render() {
    return (index.h("button", { class: Object.assign({}, this.getAppearance()) }, this.isLoading && (index.h("div", { style: { 'margin-right': '10px' }, class: "lds-ring" }, index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null))), index.h("slot", null)));
  }
};
