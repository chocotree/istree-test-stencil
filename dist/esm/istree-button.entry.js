import { r as registerInstance, h } from './index-8b468de2.js';
...
const IstreeButton = class {
  ...
  render() {
    return (h("button", { class: Object.assign({}, this.getAppearance()) }, this.isLoading && h("span", { style: { 'margin-right': '10px' }, class: "loader" }), h("slot", null)));
  }
};
IstreeButton.style = istreeButtonCss;

export { IstreeButton as istree_button };
